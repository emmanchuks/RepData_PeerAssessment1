...
#mean_total_steps_per_day <- mean(aggregate(steps_per_day))
#median_total_steps_per_day <- median(aggregate(steps_per_day))
...
#Make a panel plot containing a time series plot (i.e. type = âlâ) of the 5-minute interval (x-axis) 
